...
class HomeVC: LoadingViewController {
    ...
    private let emptyStackLabel = PawLabel(text: "End of stack. Switch up your preferences or try again later.", textColor: .black, font: markerFont(16), alignment: .center)
